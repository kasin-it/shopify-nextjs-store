        ...
        <div className="flex flex-col gap-4 rounded-lg border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-sm leading-loose text-muted-foreground">
            <p>
              ...
              weekend cleaning my house, but now I can simply turn on this
              little robot and let it do the work. It&apos;s incredibly
              efficient, navigating around obstacles with ease. The only reason
              I didn&apos;t give it a perfect 5-star rating is that it
        ...
        <div className="flex flex-col gap-4 rounded-lg border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-sm leading-loose text-muted-foreground">
            <p>
              ...
              has exceeded all my expectations. The design is sleek and modern,
              and it's been a game-changer in my daily routine. Highly
