...
export type ProductFeedCreateMutationVariables = AdminTypes.Exact<{
  [key: string]: never
}>

export type ProductFeedCreateMutation = {
  productFeedCreate?: AdminTypes.Maybe<{
    productFeed?: AdminTypes.Maybe<
      Pick<AdminTypes.ProductFeed, "status" | "id">
    >
    userErrors: Array<
      Pick<AdminTypes.ProductFeedCreateUserError, "field" | "message">
    >
  }>
}
...
export type ProductFullSyncMutation = {
  productFullSync?: AdminTypes.Maybe<{
    userErrors: Array<
      Pick<AdminTypes.ProductFullSyncUserError, "field" | "message">
    >
  }>
}
...
export type WebhookSubscriptionCreateMutation = {
  webhookSubscriptionCreate?: AdminTypes.Maybe<{
    ...
    webhookSubscription?: AdminTypes.Maybe<
      Pick<AdminTypes.WebhookSubscription, "id">
    >
  }>
}

export type LatestProductFeedsQueryVariables = AdminTypes.Exact<{
  [key: string]: never
}>

export type LatestProductFeedsQuery = {
  productFeeds: {
    nodes: Array<Pick<AdminTypes.ProductFeed, "id" | "country" | "status">>
  }
}
...
export type SingleAdminProductQuery = {
  product?: AdminTypes.Maybe<
    ...
    > & {
        ...
        nodes: Array<
          ...
          > & {
            image?: AdminTypes.Maybe<
              Pick<AdminTypes.Image, "url" | "altText" | "width" | "height">
            >
      ...
      images: {
        edges: Array<{
          node: Pick<AdminTypes.Image, "url" | "altText" | "width" | "height">
        }>
      }
      seo: Pick<AdminTypes.Seo, "title" | "description">
    }
...
export type ProductStatusQuery = {
  product?: AdminTypes.Maybe<
    Pick<AdminTypes.Product, "id" | "handle" | "status">
  >
}
