...
export type SingleCartFragment = Pick<
...
export type SingleImageFragment = Pick<
  StorefrontTypes.Image,
  "url" | "altText" | "width" | "height"
>
...
> & {
  seo?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Seo, "description" | "title">
  >
}
...
> & {
  ...
  images: {
    edges: Array<{
      node: Pick<StorefrontTypes.Image, "url" | "altText" | "width" | "height">
    }>
  }
  seo: Pick<StorefrontTypes.Seo, "description" | "title">
}
                      ...
                      variants: {
                        edges: Array<{
                          ...
                          > & {
                            selectedOptions: Array<
                              Pick<
                                StorefrontTypes.SelectedOption,
                                "name" | "value"
                              >
                            >
                          }
...
export type CreateCartMutationVariables = StorefrontTypes.Exact<{
  items?: StorefrontTypes.InputMaybe<
...
export type CreateCustomerMutation = {
  customerCreate?: StorefrontTypes.Maybe<{
    customerUserErrors: Array<
      Pick<StorefrontTypes.CustomerUserError, "code" | "field" | "message">
    >
...
export type CreateAccessTokenMutation = {
  customerAccessTokenCreate?: StorefrontTypes.Maybe<{
    ...
    customerAccessToken?: StorefrontTypes.Maybe<
      Pick<StorefrontTypes.CustomerAccessToken, "accessToken" | "expiresAt">
    >
  }>
}
...
export type PagesQueryVariables = StorefrontTypes.Exact<{
  [key: string]: never
}>
...
export type ProductsHandleQueryVariables = StorefrontTypes.Exact<{
  [key: string]: never
}>

export type ProductsHandleQuery = {
  products: { edges: Array<{ node: Pick<StorefrontTypes.Product, "handle"> }> }
}
...
export type ProductsQueryVariables = StorefrontTypes.Exact<{
  ...
  cursor?: StorefrontTypes.InputMaybe<
...
interface GeneratedQueryTypes {
  ...
  "#graphql\n    query ProductsHandle {\n      products(first: 250) {\n        edges {\n          node {\n            handle\n          }\n        }\n      }\n    }\n  ": {
    return: ProductsHandleQuery
    variables: ProductsHandleQueryVariables
  }
