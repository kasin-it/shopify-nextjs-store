        ...
        & { cost: { totalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, merchandise: (
          ...
          & { price: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, selectedOptions: Array<Pick<StorefrontTypes.SelectedOption, 'name' | 'value'>>, product: (
            ...
            & { options: Array<Pick<StorefrontTypes.ProductOption, 'id' | 'name' | 'values'>>, priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, collections: { nodes: Array<(
                ...
                ) }> }, featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'>>, images: { edges: Array<{ node: Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'> }> }, seo: Pick<StorefrontTypes.Seo, 'description' | 'title'>, metafields: Array<StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'key' | 'value'>>> }
          ) }
        ) }
      ) | (
...
export type SingleMetaobjectFragment = (
...
export type ProductsBySearchParamsQueryVariables = StorefrontTypes.Exact<{
  search?: StorefrontTypes.InputMaybe<StorefrontTypes.Scalars['String']['input']>;
...
export type ProductsBySearchParamsQuery = { products: { edges: Array<{ node: (
        Pick<StorefrontTypes.Product, 'id' | 'handle' | 'title' | 'description' | 'descriptionHtml' | 'vendor' | 'tags' | 'updatedAt' | 'createdAt'>
        & { options: Array<Pick<StorefrontTypes.ProductOption, 'id' | 'name' | 'values'>>, priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, collections: { nodes: Array<(
            Pick<StorefrontTypes.Collection, 'handle' | 'title' | 'description' | 'updatedAt' | 'id' | 'descriptionHtml'>
            & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'>> }
...
export type MetaobjectsByIdsQueryVariables = StorefrontTypes.Exact<{
  ids: Array<StorefrontTypes.Scalars['ID']['input']> | StorefrontTypes.Scalars['ID']['input'];
}>;


export type MetaobjectsByIdsQuery = { nodes: Array<StorefrontTypes.Maybe<(
    Pick<StorefrontTypes.Metaobject, 'id' | 'handle' | 'type'>
    & { fields: Array<Pick<StorefrontTypes.MetaobjectField, 'key' | 'value'>> }
  )>> };

export type ProductsByCollectionQueryVariables = StorefrontTypes.Exact<{
  collectionHandle: StorefrontTypes.Scalars['String']['input'];
  limit?: StorefrontTypes.InputMaybe<StorefrontTypes.Scalars['Int']['input']>;
}>;


export type ProductsByCollectionQuery = { collection?: StorefrontTypes.Maybe<{ products: { edges: Array<{ node: (
          Pick<StorefrontTypes.Product, 'id' | 'handle' | 'title' | 'description' | 'descriptionHtml' | 'vendor' | 'tags' | 'updatedAt' | 'createdAt'>
          & { options: Array<Pick<StorefrontTypes.ProductOption, 'id' | 'name' | 'values'>>, priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, collections: { nodes: Array<(
              Pick<StorefrontTypes.Collection, 'handle' | 'title' | 'description' | 'updatedAt' | 'id' | 'descriptionHtml'>
              & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'>> }
...
export type ProductsHandleQueryVariables = StorefrontTypes.Exact<{ [key: string]: never; }>;


export type ProductsHandleQuery = { products: { edges: Array<{ node: Pick<StorefrontTypes.Product, 'handle'> }> } };
...
interface GeneratedQueryTypes {
  ...
  "#graphql\nquery ProductsBySearchParams(\n  $search: String\n  $sortKey: ProductSortKeys\n  $reverse: Boolean\n  $numProducts: Int!\n  $cursor: String\n) {\n  products(\n    sortKey: $sortKey\n    reverse: $reverse\n    first: $numProducts\n    after: $cursor\n    query: $search\n  ) {\n    edges {\n      node {\n        ...singleProduct\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n}\n#graphql\n  fragment singleProduct on Product {\n    id\n    handle\n    title\n    description\n    descriptionHtml\n    vendor\n    options {\n      id\n      name\n      values\n    }\n    priceRange {\n      maxVariantPrice {\n        amount\n        currencyCode\n      }\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    collections(first: 15) {\n      nodes {\n        handle\n        title\n        description\n        updatedAt\n        id\n        descriptionHtml\n        image {\n          ...singleImage\n        }\n      }\n    }\n    variants(first: 250) {\n      edges {\n        node {\n          id\n          title\n          quantityAvailable\n          availableForSale\n          selectedOptions {\n            name\n            value\n          }\n          # price\n          price {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n    featuredImage {\n      ...singleImage\n    }\n    images(first: 20) {\n      edges {\n        node {\n          ...singleImage\n        }\n      }\n    }\n    seo {\n      ...seo\n    }\n    tags\n    updatedAt\n    createdAt\n      metafields(identifiers: [\n              {namespace: \"custom\", key: \"product_accordions\"},\n              {namespace: \"custom\", key: \"related_products\"},\n              {namespace: \"custom\", key: \"faq\"},\n              {namespace: \"custom\", key: \"brand\"},\n              {namespace: \"custom\", key: \"category\"},\n            ]) {\n              key\n              value\n              \n              }\n      }\n  #graphql\n  fragment singleImage on Image {\n    url\n    altText\n    width\n    height\n  }\n\n  #graphql\n  fragment seo on SEO {\n    description\n    title\n  }\n\n\n": {return: ProductsBySearchParamsQuery, variables: ProductsBySearchParamsQueryVariables},
  "#graphql\n  query MetaobjectsByIds($ids: [ID!]!) {\n    nodes(ids: $ids) {\n      ...on Metaobject {\n        ...singleMetaobject\n      }  \n    }\n  }\n  #graphql\n  fragment singleMetaobject on Metaobject {\n    id\n    handle\n    type\n    fields {\n      key\n      value\n    }\n  }\n\n": {return: MetaobjectsByIdsQuery, variables: MetaobjectsByIdsQueryVariables},
  "#graphql\n  query ProductsByCollection($collectionHandle: String!, $limit: Int) {\n    collection(handle: $collectionHandle) {\n      products(first: $limit) {\n        edges {\n          node {\n            ...singleProduct\n          }\n        }\n      }  \n    }\n  }\n  #graphql\n  fragment singleProduct on Product {\n    id\n    handle\n    title\n    description\n    descriptionHtml\n    vendor\n    options {\n      id\n      name\n      values\n    }\n    priceRange {\n      maxVariantPrice {\n        amount\n        currencyCode\n      }\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    collections(first: 15) {\n      nodes {\n        handle\n        title\n        description\n        updatedAt\n        id\n        descriptionHtml\n        image {\n          ...singleImage\n        }\n      }\n    }\n    variants(first: 250) {\n      edges {\n        node {\n          id\n          title\n          quantityAvailable\n          availableForSale\n          selectedOptions {\n            name\n            value\n          }\n          # price\n          price {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n    featuredImage {\n      ...singleImage\n    }\n    images(first: 20) {\n      edges {\n        node {\n          ...singleImage\n        }\n      }\n    }\n    seo {\n      ...seo\n    }\n    tags\n    updatedAt\n    createdAt\n      metafields(identifiers: [\n              {namespace: \"custom\", key: \"product_accordions\"},\n              {namespace: \"custom\", key: \"related_products\"},\n              {namespace: \"custom\", key: \"faq\"},\n              {namespace: \"custom\", key: \"brand\"},\n              {namespace: \"custom\", key: \"category\"},\n            ]) {\n              key\n              value\n              \n              }\n      }\n  #graphql\n  fragment singleImage on Image {\n    url\n    altText\n    width\n    height\n  }\n\n  #graphql\n  fragment seo on SEO {\n    description\n    title\n  }\n\n\n": {return: ProductsByCollectionQuery, variables: ProductsByCollectionQueryVariables},
  "#graphql\n    query ProductsHandle {\n      products(first: 250) {\n        edges {\n          node {\n            handle\n          }\n        }\n      }\n    }\n  ": {return: ProductsHandleQuery, variables: ProductsHandleQueryVariables},
