...
export function normalizeProduct(
  product: SingleProductQuery["product"]
...
export function normalizeCart(
  ...
  return {
    ...
    items: lines.edges.map(({ node }) => ({
      ...
      merchandise: {
        ...node.merchandise,
        product: { ...normalizeProduct(node.merchandise.product) },
      },
    })) as PlatformCartItem[],
  }
}
...
export function normalizeCollection(
  collection: SingleCollectionQuery["collection"]
